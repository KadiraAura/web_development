...
console.log("===== Example 3: multiway condfition statement =====")
/// check if a numeber is postitive, negaative or zero
let number = "%"
if(number>0){
...
console.log("====== Example 4: multiway condition statem in prompt function ======")
// check if a user enters a number, didn't enter
...
// to find the number of characters in a string, we us the method .length
...
console.log(` The seventh chraracter ${greeting[6]}`)
